...
#ifdef _WIN64
	SetConsoleTitleA("Korone FPS Unlocker (64-bit) Console");
#else
	SetConsoleTitleA("Korone FPS Unlocker (32-bit) Console");
#endif
...
{	
	...
	UI::Window = CreateWindow("RFUClass", "Korone FPS Unlocker", 0, 0, 0, 0, 0, NULL, NULL, instance, NULL);
	if (!UI::Window)
		return 0;
	...
	strcpy_s(NotifyIconData.szTip, "Korone FPS Unlocker");
